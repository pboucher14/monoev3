...
namespace MonoBrickFirmware.Movement
{
	...
	public class MotorBase
	{
		...
		protected OutputBitfield BitField
		{
			...
			set
			{
				// Check if only one motor is set Only if outA or outB or outC or outD
				// is set
		...
		/// <summary>
		/// Gets or sets the motor port this is set by the bitfield. Do not set this
		/// use the bitfield property instead
		/// </summary>
